...
import { METRIC_OPTIONS } from "@/polymet/data/commodities-data";
...
export default function PriceChart({
  ...
  // Calculate min and max for better visualization based on the selected metric
  const values = useMemo(
    () =>
      data.map(
        (item) => item[metricConfig.dataKey as keyof typeof item] as number
      ),
    [data, metricConfig.dataKey]
  );
